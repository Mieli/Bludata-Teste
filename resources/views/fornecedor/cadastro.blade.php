...
<div class="card mt-3">
    ...
    <div class="card-body">
        ...
        {!! Form::open(['route' => 'fornecedores.store', 'method' => 'post', 'class' => 'form-horizontal', 'onsubmit' => 'checarIdade($this)']) !!}
            ...
            <div class="row">
                 ...
                 <div class="col col-md-3">
                    ...
                    @include('formulario.select',['label' => '', 'select' => 'empresa_id', 'data' => $empresas, 'value' => '',
                                    'attributes' => [
                                        'class'       => 'form-control', 
                                        'placeholder' => 'Empresa ...'                                   
                                    ] 
